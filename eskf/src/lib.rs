...
impl Builder {
    ...
    pub fn acceleration_stddev(mut self, var: f32) -> Self {
    ...
    pub fn acceleration_stddev_from_vec(mut self, var: Vector3<f32>) -> Self {
    ...
    pub fn rotation_stddev(mut self, var: f32) -> Self {
    ...
    pub fn rotation_stddev_from_vec(mut self, var: Vector3<f32>) -> Self {
    ...
    pub fn acceleration_bias_stddev(mut self, bias: f32) -> Self {
    ...
    pub fn acceleration_bias_stddev_from_vec(mut self, bias: Vector3<f32>) -> Self {
    ...
    pub fn rotation_bias_stddev(mut self, bias: f32) -> Self {
    ...
    pub fn rotation_bias_stddev_from_vec(mut self, bias: Vector3<f32>) -> Self {
    ...
    pub fn build(self) -> ESKF {
        ESKF {
            ...
            covariance: OMatrix::<f32, U18, U18>::identity() * self.initial_covariance,
...
impl ESKF {
    ...
    /// Get the uncertainty of the acceleration bias estimate
    pub fn acceleration_bias_uncertainty(&self) -> Vector3<f32> {
        self.uncertainty3(9)
    }

    /// Get the uncertainty of the rotation bias estimate
    pub fn rotation_bias_uncertainty(&self) -> Vector3<f32> {
        self.uncertainty3(12)
    }

    /// Get the uncertainty of the gravity estimate
    pub fn gravity_uncertainty(&self) -> Vector3<f32> {
        self.uncertainty3(15)
    }
    ...
    pub fn observe_orientation(
        ...
        let diff = self.orientation.conjugate() * measurement;
